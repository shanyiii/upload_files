...
# 上傳檔案到 vector store
def upload_file(file_paths, file_name, my_vector_store):
...
# 由前端上傳檔案
def upload_file_form_user(file_path, file_name):
    ...
    #上傳檔案
    file_batch = upload_file(file_paths, file_name, my_vector_store)
    # print(f'\nfile batch:\n{file_batch}')
